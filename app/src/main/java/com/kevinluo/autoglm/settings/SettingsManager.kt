...
class SettingsManager(private val context: Context) {
    ...
    fun getModelConfig(): ModelConfig {
        ...
        return ModelConfig(
            ...
            apiKey = securePrefs.getString(KEY_API_KEY, DEFAULT_MODEL_CONFIG.apiKey)
                ?.ifEmpty { "EMPTY" } ?: "EMPTY",
            modelName = prefs.getString(KEY_MODEL_NAME, DEFAULT_MODEL_CONFIG.modelName)
    ...
    fun getAgentConfig(): AgentConfig {
        ...
        return AgentConfig(
            ...
            language = prefs.getString(KEY_LANGUAGE, DEFAULT_AGENT_CONFIG.language)
            ...
            (0 until array.length()).map { i ->
                ...
                SavedModelProfile(
                    ...
                    config = ModelConfig(
                        ...
                        frequencyPenalty = obj.optDouble(
                            "frequencyPenalty",
                            DEFAULT_MODEL_CONFIG.frequencyPenalty.toDouble()
                        ).toFloat(),
                        timeoutSeconds = obj.optLong(
                            "timeoutSeconds",
